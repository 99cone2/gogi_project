		...
		<div id="Notice_page">
			<div class="table-responsive">
				<table class="table table-striped table-sm table-hover">
					...
					<thead>
						<tr>
							<th scope="col" class="center tw fg org">번호</th>
							<th scope="col" class="center tw fg org" >제목</th>
							<th scope="col" class="center tw fg org">작성일</th>
							<th scope="col" class="center tw fg org">작성자</th>
							<th scope="col" class="center tw fg org">조회수</th>
						</tr>
					</thead>
